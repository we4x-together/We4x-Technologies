        ...
        {["status", "type", "priority", "assignee"].map((name) => {
          ...
          return (
            <select
              ...
              className=" border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white outline-none px-3 py-1 rounded text-sm"
            >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        value={task.status}
                        className="group-hover:ring ring-zinc-100 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white outline-none px-2 pr-4 py-1 rounded text-sm cursor-pointer"
                      >
                        <option
                          value="TODO"
                          style={{
